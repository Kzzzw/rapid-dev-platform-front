            ...
            <template #title>
                <div>
                    <span class="title-icon">
                        <icon-font v-if="titleType=='prompt'"  type="icon-a-tishidanchuang" />
                        <icon-font v-if="titleType=='success'" type="icon-chenggong-xiao" />
                        <icon-font v-if="titleType=='fail'" type="icon-shibai-xiao" />
                    </span>
                    <span>{{title}}</span>
                </div>
            </template>
